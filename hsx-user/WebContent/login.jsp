...
<html lang="en">
	<head>
		...
		<!-- ace styles -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/ace/css/ace.css" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/ace/css/ace-part2.css" />
		<![endif]-->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/admin/ace/css/ace-rtl.css" />
		...
		<script type="text/javascript">
			$(function(){
				$("#changeImg").click(function() {
					$("#ccodeImg").attr("src", "${pageContext.request.contextPath}/IdentifyCode?d="+(Math.floor(Math.random() * (1000 + 1)) ));
				});
			});
		</script>
						...
						<div class="login-container">
							<div class="center">
								<h1>
									...
									<span class="red">云医助手</span>
									<span class="white" id="id-text2">后台管理系统</span>
								</h1>
								<h4 class="blue" id="id-company-text">&copy; 广东中实国润</h4>
							</div>
									...
									<div class="widget-body">
										<div class="widget-main">
											<h4 class="header blue lighter bigger">
												<i class="ace-icon fa fa-coffee green"></i>登录信息<font color="red">${result.desc}</font>
											</h4>

											<div class="space-6"></div>

											<form action="${pageContext.request.contextPath}/login/execute" method="post" >
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="uesrName" class="form-control" placeholder="账号" />
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															...
															<i class="ace-icon fa fa-user"><img border="0" src="${pageContext.request.contextPath}/IdentifyCode" id="ccodeImg" width="71" height="27" alt="验证码"/></a></td></i>
														</span>
													</label>
							...
							<div class="navbar-fixed-top align-right">
								<br />
								&nbsp;
								<a id="btn-login-dark" href="#">灰暗</a>
								&nbsp;
								<span class="blue">/</span>
								&nbsp;
								<a id="btn-login-blur" href="#">普通</a>
								&nbsp;
								<span class="blue">/</span>
								&nbsp;
